...
const FilterSection = ({search, setSearch, brand, setBrand, priceRange, setPriceRange, category, setCategory,handleBrandChange, handleCategoryChange}) => {
    ...
    return (
        <div className='bg-gray-100 mt-10 p-4 rounded-md h-max'>
           ...
           <select className='bg-white w-full p-2 border-gray-300 border-2 rotate-md' 
           value={brand}
           ...
           onClick={()=>{setSearch(''); setCategory('All'); setBrand('All'); setPriceRange(''); setPriceRange([0,5000])}}>Reset Fillters </button>
