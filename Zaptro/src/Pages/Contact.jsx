      ...
      <div className="backdrop-blur-md bg-white/10 border border-white/20 rounded-2xl shadow-2xl p-10 w-full max-w-5xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="text-white space-y-6">
            ...
            <div>
              <p><strong>📍 Address:</strong> 56/11/4,Dharmatala Lane, Shibpur, Howrah, India</p>
              <p><strong>📧 Email:</strong> rockpallab700@gmail.com</p>
              <p><strong>📞 Phone:</strong> +91 7003210921</p>
            </div>
          </div>
